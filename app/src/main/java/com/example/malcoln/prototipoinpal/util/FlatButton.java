...
public class FlatButton extends android.support.v7.widget.AppCompatButton {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        TypedArray attr = getTypedArray(context, attributeSet, com.dd.processbutton.R.styleable.FlatButton);
        if(attr == null) {
            return;
        }
        ...
        try {
            ...
            float defValue = getDimension(com.dd.processbutton.R.dimen.corner_radius);
            cornerRadius = attr.getDimension(com.dd.processbutton.R.styleable.FlatButton_pb_cornerRadius, defValue);
    ...
    private LayerDrawable createNormalDrawable(TypedArray attr) {
        LayerDrawable drawableNormal =
                (LayerDrawable) getDrawable(com.dd.processbutton.R.drawable.rect_normal).mutate();
        ...
        int blueDark = getColor(com.dd.processbutton.R.color.blue_pressed);
        int colorPressed = attr.getColor(com.dd.processbutton.R.styleable.FlatButton_pb_colorPressed, blueDark);
        ...
        int blueNormal = getColor(com.dd.processbutton.R.color.blue_normal);
        int colorNormal = attr.getColor(com.dd.processbutton.R.styleable.FlatButton_pb_colorNormal, blueNormal);
    ...
    private Drawable createPressedDrawable(TypedArray attr) {
        GradientDrawable drawablePressed =
                (GradientDrawable) getDrawable(com.dd.processbutton.R.drawable.rect_pressed).mutate();
